...
public class Loginx {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Login().setVisible(true); // Abre a tela de Login primeiro
            }
        });
    }
}
...
class Login extends JFrame {
    ...
    public Login() {
        ...
        JLabel lblUsuario = new JLabel("Usuário (Nome Completo):"); // Mudar para "Usuário (E-mail)"
        ...
        btnEntrar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String usuario = txtUsuario.getText(); // Usar "email" como nome da variável
                ...
                try (Connection conexao = ConexaoBD.obterConexao()) {
                    ...
                    try (PreparedStatement stmt = conexao.prepareStatement("SELECT * FROM Usuarios WHERE NomeCompleto = ? AND CPF = ?")) {
        ...
        btnVoltar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // Cria uma nova instância da tela Home e a exibe
                Home home = new Home();
                home.setVisible(true);
                // Fecha a tela de Login
                dispose();
